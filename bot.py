...
tools = ToolsSchema(standard_tools=[mens_basketball, womens_basketball])
...
async def main(args: SessionArguments):
    ...
    stt = OpenAISTTService(
        ...
        prompt="Expect words related to college basketball and the March Madness tournament.",
    )

    tts = OpenAITTSService(
        api_key=os.getenv("OPENAI_API_KEY"), model="gpt-4o-mini-tts-latest"
    )
    ...
    llm.register_function(
        "get_womens_basketball_scores", fetch_womens_basketball_scores
    )
    ...
    context = OpenAILLMContext(
        [
            {
                "role": "system",
                "content": """You are a helpful and friendly AI. Your knowledge cutoff is 2023-10. 
...
Remember, your responses should be short. Just one or two sentences, usually.""",
            ...
            {
                "role": "user",
                "content": "Say hello, and tell me you are a March Madness expert!",
            },
        ],
        tools,
    )
